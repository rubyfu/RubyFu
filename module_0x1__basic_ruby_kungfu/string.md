...
Since we mostly working with command-line, we need our output to be more elegant. Here main colors you may need to do so. you can add to add to these set.
