...
The is a very basic script take your given payload and send it to the vulnerable parameter and returns the response back to you. I'll use \([http://testphp.vulnweb.com/](http://testphp.vulnweb.com/)\) as it's legal to test.
...
Try it on this URL \([http://testasp.vulnweb.com/showforum.asp?id=0](http://testasp.vulnweb.com/showforum.asp?id=0)\)
