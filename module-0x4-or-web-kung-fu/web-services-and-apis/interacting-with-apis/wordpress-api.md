...
Ruby has a [standard library](http://ruby-doc.org/stdlib-2.2.3/libdoc/xmlrpc/rdoc/XMLRPC/Client.html) called `xmlrpc` which takes care of all xmlrpc stuff, you can even create an XML-RPC server using it. Let's to get some real word example
...
and here is the new post ![](../../../.gitbook/assets/webfu__xmlrpc1.png)
